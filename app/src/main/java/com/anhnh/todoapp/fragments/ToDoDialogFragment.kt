...
import com.anhnh.todoapp.databinding.FragmentToDoDialogBinding
...
class ToDoDialogFragment : DialogFragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(taskId: Int, task: String) = ToDoDialogFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            ...
            toDoData =
                ToDoData(arguments?.getInt("taskId")!!, arguments?.getString("task").toString())
